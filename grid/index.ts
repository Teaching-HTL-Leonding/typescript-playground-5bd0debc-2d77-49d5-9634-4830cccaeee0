function setup() {
    ...
    let j = GRID;            // STEP 1: Initialize the loop variable
    while (j < SIZE) {       // STEP 2: Check the loop condition
        line(0, j, SIZE, j); // STEP 3: Do whatever you want to do repeatedly
        j += GRID;           // STEP 4: Update the loop variable
    }
